...
DPYD_VARIANT_PHENOTYPE = {
    "rs3918290":   {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                    "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs55886062":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                    "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs67376798":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                    "1/1": "Intermediate Metabolizer",  "1|1": "Intermediate Metabolizer"},
    "rs1801160":   {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                    "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs1801265":   {"0/1": "Normal Metabolizer",       "0|1": "Normal Metabolizer",
                    "1/1": "Normal Metabolizer",        "1|1": "Normal Metabolizer"},
}

# ── CYP2D6 rsID → phenotype ──────────────────────────────────────────────────
CYP2D6_VARIANT_PHENOTYPE = {
    "rs3892097":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs1065852":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs5030655":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs16947":    {"0/1": "Normal Metabolizer",       "0|1": "Normal Metabolizer",
                   "1/1": "Normal Metabolizer",        "1|1": "Normal Metabolizer"},
}

# ── CYP2C19 rsID → phenotype ─────────────────────────────────────────────────
CYP2C19_VARIANT_PHENOTYPE = {
    "rs4244285":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs4986893":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs28399504": {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
}

# ── CYP2C9 rsID → phenotype ──────────────────────────────────────────────────
CYP2C9_VARIANT_PHENOTYPE = {
    "rs1799853":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs1057910":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
}

# ── SLCO1B1 rsID → phenotype ─────────────────────────────────────────────────
SLCO1B1_VARIANT_PHENOTYPE = {
    "rs4149056":  {"0/1": "Decreased Function", "0|1": "Decreased Function",
                   "1/1": "Poor Function",       "1|1": "Poor Function"},
}

# ── TPMT rsID → phenotype ────────────────────────────────────────────────────
TPMT_VARIANT_PHENOTYPE = {
    "rs1800460":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs1142345":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
    "rs1800584":  {"0/1": "Intermediate Metabolizer", "0|1": "Intermediate Metabolizer",
                   "1/1": "Poor Metabolizer",          "1|1": "Poor Metabolizer"},
}
...
def infer_phenotype(gene: str, variants: list, diplotype: str) -> str:
    ...
    for v in variants:
        ...
        if rsid in gene_table and gt in gene_table[rsid]:
